...
int		declareModule(atom_t name, SourceFile sf, int line);
...
word		pl_declare_module(term_t name, term_t file, term_t line);
...
Definition	trapUndefined(LocalFrame fr, Code PC, Procedure proc ARG_LD);
